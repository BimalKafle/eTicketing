	  ...
	  <h3>About Us</h3>
	   ...
	   <div class="container">		  
		 ...
		 <div class="col-md-4 about-grids grid2">
			 <h4>Our Mission</h4>
			 <p>We strive to incorporate the following ideals, morals and beliefs into our business: To provide a warm, professional, and knowledgeable service to all clients, as well as to potential client.</p>
		 </div>
		 <div class="col-md-4 about-grids">
